...
public class TestNUPlannerModel {
  ...
  public void testBaseConstructor() {
    NUPlanner model = new PlannerModel(new WorkHoursStrategy(true));
  ...
  public void testXMLConstructor() {
    ...
    NUPlanner model = new PlannerModel(xmlDocs, new WorkHoursStrategy(true));
  ...
  // tests addSchedule functionality.
  @Test
  ...
  // tests a valid call to addEvent.
  @Test
  ...
  // tests getScheduleByUser method.
  @Test
  public void testGetScheduleByUser() {
    ...
    // tests a valid call to removeEvent when caller is host.   Assert.assertEquals(schedule.copyEventList().size(), 2);
  }
  ...
  // tests a valid call to removeEvent when caller is not host.
  @Test
  ...
  // tests a valid call to modifyEvent.
  @Test
  ...
  // test an invalid call to modifyEvent.
  @Test
  ...
  // test the first day of the planner is correct.
  @Test
  public void testValidateStartDays() {
    ...
    model.add(event, "Second");
    model.add(event2, "Mock");
    Assert.assertEquals(model.startDay(), Day.SUNDAY);
  }
}

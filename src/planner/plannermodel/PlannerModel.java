...
/**
 * A class for representing a list of model of PlannerModel.PlannerModel.NUPlanner.
 */
public class PlannerModel implements NUPlanner {
   ...
   * Constructor.
   */
  public PlannerModel(Strategy strategy) {
   ...
   */
  public PlannerModel(List<String> xmlDocs, Strategy strategy) {
  ...
  public ISchedule addSchedule(String username) {
    ...
    ISchedule s =  new Schedule(username, true);
    schedules.add(s);
    return s;
  }
